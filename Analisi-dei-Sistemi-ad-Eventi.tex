...
\begin{tabular}{|c|c|c|}
    \hline
    Stato $t$ & Evento in $\Delta t$ & Probabilità $P_n$ \\
    \hline
...
\begin{gather*}
    N=\rho P_0\displaystyle\sum_{n=0}^{\infty}\frac{d}{d\rho}\rho^n=\rho P_0\frac{d}{d\rho}\left(\sum_{n=0}^{\infty}\rho^n\right)=\rho P_0\frac{d}{d\rho}\left(\frac{1}{1-\rho}\right)\\
    N=\displaystyle\frac{\rho(1-\rho)}{(1-\rho)^2}=\frac{\rho}{1-\rho}=\frac{\displaystyle\frac{\lambda}{\mu}}{1-\displaystyle\frac{\lambda}{\mu}}=\frac{\lambda}{\mu-\lambda}
\end{gather*}
