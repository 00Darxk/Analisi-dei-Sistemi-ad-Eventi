...
\fancypagestyle{link}{\fancyhf{}\renewcommand{\headrulewidth}{0pt}\fancyfoot[C]{Sorgente del file LaTeX disponibile al seguente link: \url{https://github.com/00Darxk/Analisi-dei-Sistemi-ad-Eventi}}}
...
\pagestyle{fancy}
\fancyhead{}\fancyfoot{}
\fancyhead[C]{\textit{Analisi dei Sistemi ad Eventi - Università degli Studi ``Roma Tre"}}
\fancyfoot[C]{\thepage}
\pagenumbering{Roman}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[place, structured tokens={n}, label=right:$p_1$](p1)at(0,1){};
        \node[place, structured tokens={m}, label=right:$p_2$](p2)at(0,-1){};

        \draw[->](p1.270)--(t.0)node[midway, right]{$k$};
        \draw[->](t.180)--(p2.90)node[midway, right]{$k$};
        ...
        \node[place, structured tokens={n,m}, label=right:$p_{1,2}$](p3)at(3,0){};
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[place, structured tokens={n}, label=right:$p_1$](p1)at(1,0){};
        \node[place, structured tokens={m}, label=left:$p_2$](p2)at(-1,0){};

        \draw[->](t1.190)--(p1.90)node[midway, right]{$k_1$};
        \draw[->](t1.170)--(p2.90)node[midway, left]{$k_2$};
        \draw[<-](t2.350)--(p1.270)node[midway, right]{$n_1$};
        \draw[<-](t2.10)--(p2.270)node[midway, left]{$n_2$};
        
        \draw[->,very thick](1.8,0)--(3.5,0);

        \node[transition, rotate=90, label=below:$t_1$](t3)at(4,1.5){};
        \node[transition, rotate=90, label=below:$t_2$](t4)at(4,-1.5){}; 
        \node[place, structured tokens={n,m}, label=right:$p_{1,2}$](p3)at(4,0){};
        
        \draw[->](t3.180)--(p3.90)node[midway, right]{$k_1+k_2$};
        \draw[->](p3.270)--(t4.0)node[midway, right]{$n_1+n_2$};
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[->](p1.315)--(t1.0)node[midway, right]{$k$};
        \draw[->](p1.225)--(t2.0)node[midway, left]{$k$};
        \draw[->](t1.180)--(p2.45)node[midway, right]{$n$};
        \draw[->](t2.180)--(p2.135)node[midway, left]{$n$};

        \draw[->,very thick](1.75,0)--(3.5,0);
        ...
        \draw[->](p3.270)--(t3.0)node[midway, right]{$k$};
        \draw[->](t3.180)--(p4.90)node[midway, right]{$n$};
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[->](t1.45)to[out=135,in=45](p1.45);
        \draw[<-](t1.135)to[out=225,in=315](p1.315);

        \draw[->](1.5,-1)--(t1.180);
        \draw[->](t1.0)--(1.5,1);

        \draw[->,very thick](2.25,0)--(3.5,0);
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[place,tokens=0,rotate=90,label=above:$p_1$](t3)at(0.25,-2){};
        \node[place,tokens=0,rotate=90,label=below:$p_1$](t4)at(1.75,-2){};
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[transition, rotate=90, label=above:$t_{A.\mathrm{pick}}$](rap)at(1,-3){};
        \node[transition, rotate=90, label=below:$t_{B.\mathrm{pick}}$](rbp)at(3,-3){};
        \node[place,tokens=0,label=left:$A\in R$](ra1)at(1,-4){};
        \node[place,tokens=0,label=right:$B\in R$](rb1)at(3,-4){};
        \node[transition, rotate=90, label=above:$t_{A.\mathrm{move}}$](ram)at(1,-5){};
        \node[transition, rotate=90, label=below:$t_{B.\mathrm{move}}$](rbm)at(3,-5){};
        \node[place,tokens=0,label=left:$A\in R$](ra2)at(1,-6){};
        \node[place,tokens=0,label=right:$B\in R$](rb2)at(3,-6){};
        \node[transition, rotate=90, label=above:$t_{A.\mathrm{release}}$](rar)at(1,-7){};
        \node[transition, rotate=90, label=below:$t_{B.\mathrm{release}}$](rbr)at(3,-7){};
    ...
    \end{tikzpicture}
\end{center}
Le transizioni in sequenza $t_{A/B.\mathrm{pick}},\;t_{A/B.\mathrm{move}},\;t_{A/B.\mathrm{release}}$ possono essere sostituite da un'unica transizione associata ad un intervallo di tempo pari alla 
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[place,tokens=0,label=left:$R_A$](ra)at(1,-2){};
        \node[place,tokens=0,label=right:$R_B$](rb)at(3,-2){};
        \node[transition, rotate=90, label=above:$t_{A.\mathrm{move}}$](rap)at(1,-3){};
        \node[transition, rotate=90, label=below:$t_{B.\mathrm{move}}$](rbp)at(3,-3){};
        \draw[->](tra.180)--(ra.90);
        \draw[->](ra.270)--(rap.0);
        \draw[->](trb.180)--(rb.90);
        \draw[->](rb.270)--(rbp.0);
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[transition, rotate=90, label=above:$t_{A.\mathrm{make}}$](amake)at(1,-5){};
        \node[transition, rotate=90, label=below:$t_{B.\mathrm{make}}$](bmake)at(3,-5){};
        ...
        \draw[->](rabf.180)--(rf.90);
        \node[transition, rotate=90,label=above:$t_{(A_f,B_f).\mathrm{pick}}$](trf)at(2,-9){};
        ...
        \node[transition, rotate=90,label=above:$t_{P.\mathrm{make}}$](trp)at(2,-11){};
...
A questo 
punto si rappresenta l'assemblaggio finale come una transizione temporizzata $t_{P.\mathrm{make}}$, che porta allo stato $P\in R$, dove $P$ denota il prodotto finale, contenuto ancora 
...
nel buffer finale a questo punto viene trasportato fuori dal sistema, modellato con un altra transizione temporizzata $t_{P.\mathrm{out}}$:
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[transition, rotate=45,label=above:$t_{P.\mathrm{make}}$](trp)at(2,-11){};
        \node[place,tokens=0,label=below left:${P\in R}$](rp)at(3,-11){};

        \draw[->](ttrf.270)--(trp.45);
        \draw[->](trp.315)--(rp.180);

        \node[transition, label=below:$t_{P.\mathrm{move}}$](tpm)at(4,-11){};
        \draw[->](rp.0)--(tpm.180);
        ...
        \node[transition, label=right:$t_{P.\mathrm{out}}$](tpo)at(6,-11){};
        \draw[->](po.315)--(tpo.135);
        \draw[->](tpo.225)--(pio.45);
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[place, tokens=1, label=below:$R_A$](a)at(2,0){};
        \node[place, tokens=0, label=below:$R_B$](b)at(2,-2){};
...
Si modella un buffer nella convenzione First In First Out, tramite archi inibitori, dove la transizione $t_\mathrm{out}$ determina l'uscita dell'elemento dal buffer. Si 
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[transition,label=above:$t_\mathrm{out}$](t0)at(7,0){};
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[place,label=above:$G_n$](p0)at(1,0){};
        \node[instant](ta)at(2,0){};
        \node[transition,rotate=90,label=left:$t_\mathrm{out}$](t00)at(1,-1){};
        \node[instant](t1)at(3,0){};
        \node[place,label=above:$G_2$](p1)at(4,0){};
        \node[instant](t2)at(5,0){};
        \node[transition,rotate=90,label=left:$t_\mathrm{out}$](t01)at(4,-1){};
        \node[place,label=above:$G_1$](p2)at(6,0){};
        \node[transition,rotate=90,label=left:$t_\mathrm{out}$](t02)at(6,-1){};
        ...
        \draw[-{Circle[]}](p2.135)to[out=135,in=45](t2.45);
        \draw[-{Circle[]}](p1.135)to[out=135,in=45](t1.45);
        \draw[dashed](p0.330)to[out=330,in=180](t02.90);
        \draw[dashed,->](ta.0)--(t1.180);
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{ganttchart}[
        ...
        \gantttitle{Diagramma di Gantt}{15}\\
        \gantttitlelist{1,...,15}{1}\\
        \ganttbar[bar/.append style={fill=red}]{Risorsa 1}{1}{4}\ganttbar[bar/.append style={fill=blue}]{}{5}{8}\ganttbar[bar/.append style={fill=red}]{}{12}{15}\\
        \ganttbar[bar/.append style={fill=blue}]{Risorsa 2}{1}{3}\ganttbar[bar/.append style={fill=red}]{}{5}{7}\ganttbar[bar/.append style={fill=blue}]{}{9}{11}\\
        \ganttbar[bar/.append style={fill=red}]{Risorsa 3}{8}{11}\ganttbar[bar/.append style={fill=blue}]{}{12}{15}
    \end{ganttchart}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        \node[transition, rotate=90, label=above:$t_\mathrm{in}$](tin)at(0,2){};
        \node[place, label=left:$G_\mathrm{in}$](gin)at(0,1){};
        \draw[->](tin.180)--(gin.90);
        ...
        \node[transition, rotate=90, label=below:$G_{{\geq n}_\mathrm{in}}$](tgin)at(7.5,-1){};
        \draw[->](gn.270)--(tgin.0);
...
\begin{center}
    \begin{tikzpicture}
        ...
        %% fix labels
        \draw[->](n0.315)to[out=315,in=225](n1.225)node[below right]{$\lambda_{n-1}$};
        \draw[->](n1.315)to[out=315,in=225](n2.225)node[below right]{$\lambda_{n}$};
        \draw[->](n2.135)to[out=135,in=45](n1.45)node[above left]{$\mu_{n+1}$};
        \draw[->](n1.135)to[out=135,in=45](n0.45)node[above left]{$\mu_n$};
    \end{tikzpicture}
\end{center}
