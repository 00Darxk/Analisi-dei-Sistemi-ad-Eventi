...
\begin{center}
    \begin{tikzpicture}
        \node[transition,rotate=90,label=above:$t_1$](t1)at(0,0){};
        \node[instant,rotate=90,label=below:$t_2$](t2)at(2,0){};
        \draw[->](0,1)--(t1.0);
        \draw[->](t1.180)--(0,-1);
        \draw[->](2,1)--(t2.0);
        \draw[->](t2.180)--(2,-1);
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[transition,rotate=90,label=below:$t_3$](t3)at(2,1){};
...
In caso il sistema presenta una pila o una coda, bisogna modellarla o in convenzione FIFO o LIFO. 
Si modella un buffer nella convenzione First In First Out, tramite archi inibitori, dove la transizione $t_{out}$ determina l'uscita dell'elemento dal buffer
\begin{center}
    \begin{tikzpicture}
        \node[place,label=above:$R$](r)at(0,0){};
        \node[instant,label=above:$t_1$](t1)at(1,0){};
        \node[place,label=above:$p_1$](p1)at(2,0){};
        \node[instant,label=above:$t_2$](t2)at(3,0){};
        \node[place,label=above:$p_2$](p2)at(4,0){};
        \node[transition,label=above:$t_{out}$](t0)at(5,0){};
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[instant,label=above:$t_2$](t2)at(3,0){};
        \node[place,label=above:$p_2$](p2)at(4,0){};
        \node[transition,label=above:$t_{out}$](t01)at(5,0.5){};
        \node[transition,label=above:$t_{out}$](t02)at(5,-0.5){};
        ...
        \draw[-{Circle[]}](p2.135)to[out=135,in=45](t2.45);
        \draw[-{Circle[]}](p1.135)to[out=135,in=45](t1.45);
        \draw[-{Circle[]}](p1.45)to[out=45,in=135](t01.135);
        \draw[->](p1.315)to[out=315,in=225](t02.225);
    \end{tikzpicture}
\end{center}
