...
\begin{itemize}
    \item Il valore atteso del numero dei clienti è costante $N=\mbox{cost.}$;
...
%% tabella 21/12
%Si indica come può essere calcolato ricorsivamente il fattore di normalizzazione $G(N)$ utilizzando una tabella per indicare le probabilità per ogni stazione: 
%\begin{center}
